...
write.table(result_l, file="1105_sim_B.csv",row.names=FALSE,col.names=FALSE, sep=",")
adj_m[lower.tri(adj_m)] <- t(adj_m)[lower.tri(adj_m)]
write.csv(adj_m, file="1105_sim_B_adjm.csv", )
...
write.table(wordmat, file="1105_sim_B_wordmat.csv",row.names=FALSE,col.names=FALSE, sep=",")
